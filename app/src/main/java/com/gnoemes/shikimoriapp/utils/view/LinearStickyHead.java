 ...
 */
public class LinearStickyHead<T extends RecyclerView.Adapter & StickyHeaders>
    ...
    public LinearStickyHead(Context context) {
        super(context);
    }

    public LinearStickyHead(Context context, int orientation, boolean reverseLayout) {

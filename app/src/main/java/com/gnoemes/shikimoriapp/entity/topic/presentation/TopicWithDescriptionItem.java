...
public class TopicWithDescriptionItem extends BaseTopicItem {
    ...
    public TopicWithDescriptionItem(long id, String title, String description, DateTime createdDate,

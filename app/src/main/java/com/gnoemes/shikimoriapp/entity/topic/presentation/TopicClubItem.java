...
public class TopicClubItem extends BaseTopicItem {
    ...
    public TopicClubItem(long id, String title, DateTime createdDate,
                         long commentsCount, UserBrief userBrief,
                         TopicType type, Forum forum, @Nullable LinkedContent linkedContent,
                         @Nullable LinkedType linkedType, boolean isViewed) {
        this.id = id;
        this.title = title;

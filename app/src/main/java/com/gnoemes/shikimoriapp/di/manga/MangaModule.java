...
public interface MangaModule {
    ...
    static MangaPresenter provideMangaPresenter(MangaInteractor mangaInteractor,
        ...
        return new MangaPresenter(mangaInteractor, ranobeInteractor, userRatesInteractor, userSettingsInteractor, resourceProvider, linkViewModelConverter, analyticsInteractor);
    }

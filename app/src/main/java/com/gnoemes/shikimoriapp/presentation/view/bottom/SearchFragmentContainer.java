...
public class SearchFragmentContainer extends BottomTabContainer {
    ...
    public static SearchFragmentContainer newInstance() {
        Bundle args = new Bundle();
        SearchFragmentContainer fragment = new SearchFragmentContainer();

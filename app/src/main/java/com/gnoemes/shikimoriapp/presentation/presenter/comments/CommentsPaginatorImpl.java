...
public class CommentsPaginatorImpl implements CommentsPaginator {

    private CommentsInteractor interactor;
    private ViewController<Comment> viewController;

    private int currentPage;
    private int defaultPage = 1;

    private State currentState = new EMPTY_STATE();
    private List<Comment> currentData = Collections.emptyList();
    private long id;

    private Disposable disposable;

    public CommentsPaginatorImpl(CommentsInteractor interactor,
                                 ViewController<Comment> viewController) {
    ...
    private void loadPage(int page) {
        ...
        disposable = interactor.getComments(id, page, AppConfig.DEFAULT_LIMIT)
                .subscribe(
    ...
    private interface State {
        ...
        void newData(List<Comment> list);
    ...
    private abstract class EMPTY implements State {
        ...
        @Override
        public void newData(List<Comment> list) {
        }

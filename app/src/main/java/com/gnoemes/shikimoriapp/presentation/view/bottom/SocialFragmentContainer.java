...
public class SocialFragmentContainer extends BottomTabContainer {
    ...
    public static SocialFragmentContainer newInstance() {
        Bundle args = new Bundle();
        SocialFragmentContainer fragment = new SocialFragmentContainer();

...
public class UserHistoryPaginatorImpl implements UserHistoryPaginator {
    ...
    private List<UserHistory> currentData = Collections.emptyList();
    private long id;
    ...
    private void loadPage(int page) {
        ...
        disposable = interactor.getUserHistory(id, page, AppConfig.BIG_LIMIT)
                .subscribe(
    ...
    private interface State {
        ...
        void newData(List<UserHistory> list);
    ...
    private abstract class EMPTY implements State {
        ...
        @Override
        public void newData(List<UserHistory> list) {
        }
